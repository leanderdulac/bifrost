...
namespace PagarMe.Bifrost.Setup.Helper
{
    internal class InstallerContents : ProgramVersion
    {
        public static void PublishLinux()
        {
            ...
            makeLinuxZip(currentVersion, installersPath);
        ...
        private static void makeLinuxZip(String currentVersion, String installersPath)
        {
            ...
            var zip = Path.Combine(installersPath, $"bifrost-linux-{currentVersion}.zip");
        ...
        public static void PublishWindows()
        {
            ...
            var msi = Path.Combine(installersPath, $"bifrost-windows-{currentVersion}.msi");
